...
class PEAREmailerConfig {
	...
	public static $availableErrors = array(
		PEAREmailerConfig::ERROR_RECIPIENT_UNSUBSCRIBED 	=> 'That recipient has unsubscribed.',
		PEAREmailerConfig::ERROR_INVALID_EMAIL 				=> 'That email is invalid.',
		PEAREmailerConfig::ERROR_TOO_LONG 					=> 'That string is too long.',
		PEAREmailerConfig::ERROR_SMTP 						=> 'SMTP returned the following error "%s".',
		PEAREmailerConfig::ERROR_INVALID_TEXT_TEMPLATE 		=> 'That text template is invalid.',
		PEAREmailerConfig::ERROR_INVALID_HTML_TEMPLATE 		=> 'That HTML template is invalid.'
	);
